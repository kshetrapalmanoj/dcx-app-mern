      ...
      <div>
        ...
        <div id="container">
          ...
          <section>
            ...
            <form method="POST"  onSubmit={this.stopSubmission} data-testid="form">
              {error}
              {status}
              <div>
              ...
              <select className="custom-select" name="group" value={this.state.group}
                onChange={(e) =>
              ...
              <br></br>
              <div>
                <button className="btn btn-outline-success mt-2 btn-sm" disabled={!this.state.group} type="submit">Submit</button>
